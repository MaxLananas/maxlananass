...
export function sitePages() {
  const pages = [
    ...
    { path: "/projects/", title: "Minecraft & software projects by MaxLananas", heading: "Projects by MaxLananas", description: "Explore MaxLananas’s Minecraft mods, Paper plugins, Axiom addon, BTE tools, community documentation and software projects, with sources and requirements.", type: "CollectionPage" },
    ...
    { path: "/development/", title: "Minecraft development, plugins & web tools | MaxLananas", heading: "Minecraft development and software tools", description: "Client mods, server plugins, an Axiom addon and web-to-desktop experiments by MaxLananas. Compare environments and find the documented source projects.", type: "CollectionPage" },
