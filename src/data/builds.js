...
export const FEATURED = [
  {
    ...
    index: "01",
    title: ["MrBeast"],
    kicker: "Collaboration · 2025",
    copy: "A 10-builder collaboration featured in a MrBeast video — event-scale architecture under a brutal deadline.",
  },
  {
    id: "mans",
    file: "circuit24hdumans.jpg",
    index: "02",
    title: ["24h", "du Mans"],
    kicker: "BuildTheEarth France · 1:1",
    copy: "The endurance circuit, translated block by block at true scale.",
  },
  {
    id: "loire",
    file: "chateau_loire.png",
    index: "03",
    title: ["Château", "de la Loire"],
    kicker: "Endorah · Volunteer",
    copy: "Stone, gardens and a Renaissance silhouette for a non-profit world.",
  },
  {
    id: "f4g",
    file: "spawnfight4glory.jpg",
    index: "04",
    title: ["Fight4Glory"],
    kicker: "Event spawn",
    copy: "A competition lobby designed to hold a crowd and a camera.",
  },
  {
    id: "occi",
    file: "Occi.png",
    index: "05",
    title: ["Occi"],
    kicker: "BuildTheEarth · Corsica",
    copy: "An abandoned, haunted village in Corsica — rebuilt at 1:1, empty streets and all.",
  },
];
